...
import com.programmers.apitest.configures.JwtTokenConfigure;
import com.programmers.apitest.security.WithMockJwtAuthentication;
...
class OrderRestControllerTest {
    ...
    @Test
    @WithMockJwtAuthentication
    @DisplayName("주문 개별 조회 테스트")
    void findByIdSuccessTest2() throws Exception {
        int i = 4;
        ResultActions result = mockMvc.perform(
                get("/api/orders/" + i)
                        .accept(MediaType.APPLICATION_JSON)
